                    ...
                    >
                      <article className={classes.timeline_entry}>
                        ...
                        <div className={classes.label}>
                          ...
                          <p>
                            I have experienced of being a Campus Ambassador at Internshala and International MUN and have also worked as a volunteer for National Service Scheme(NSS),VIT Bhopal.
                          </p>
                        </div>
                      </article>
                    </ScrollAnimation>
                    ...
                    >
                      <article>
                        ...
                        <div className={classes.label}>
                          <h2>Internship</h2>
                          <p>
                            Completed one month online Internship in Web Development at The Cyber Delta,Bengaluru(India).
                          </p>
                        </div>
